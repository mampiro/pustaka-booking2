...
class ModelBooking extends CI_Model
{
    ...
    public function simpanDetail($where = null)
    {
        ...
        booking.id_booking,temp.id_buku FROM booking, temp WHERE temp.id_user=booking.id_user AND
    ...
    {
        $this->db->query('CREATE TABLE IF NOT EXISTS temp(id_booking varchar(12), tgl_booking
        DATETIME, email_user varchar(128), id_buku int)');
    }
